...
// geen copyconstructor voorzien; let op! (heb je normaliter niet nodig)
...
Regexp::Regexp(const string& re):op1(0),op2(0){
...
Regexp::Regexp(const string& re,bool alvoorzienvanplus):op1(0),op2(0){
